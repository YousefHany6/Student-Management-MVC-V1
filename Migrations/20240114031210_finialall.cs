...
{
    /// <inheritdoc />
    public partial class finialall : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TermStageId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ChildStageId = table.Column<int>(type: "int", nullable: false),
                    ParentStageId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TermStages", x => x.TermStageId);
                    table.ForeignKey(
                        name: "FK_TermStages_childStages_ChildStageId",
                        column: x => x.ChildStageId,
                        principalTable: "childStages",
                        principalColumn: "ChildStageId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TermStages_parentStages_ParentStageId",
                        column: x => x.ParentStageId,
                        principalTable: "parentStages",
                        principalColumn: "ParentStageId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Courses_TermStages_TermStageId",
                        column: x => x.TermStageId,
                        principalTable: "TermStages",
                        principalColumn: "TermStageId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Courses_childStages_ChildStageId",
                        column: x => x.ChildStageId,
                        principalTable: "childStages",
                        principalColumn: "ChildStageId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Students_TermStages_TermStageId",
                        column: x => x.TermStageId,
                        principalTable: "TermStages",
                        principalColumn: "TermStageId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherCourses", x => new { x.Teacher_ID, x.Course_ID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_teacherStageCourses", x => new { x.TeacherId, x.ParentStageId, x.ChildStageId, x.TermStageId, x.CourseId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_teacherStageCourses_TermStages_TermStageId",
                        column: x => x.TermStageId,
                        principalTable: "TermStages",
                        principalColumn: "TermStageId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_teacherStageCourses_childStages_ChildStageId",
                        column: x => x.ChildStageId,
                        principalTable: "childStages",
                        principalColumn: "ChildStageId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_studentTeachers", x => new { x.Student_ID, x.Teacher_ID, x.CourseID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_teacherStageCourses_ChildStageId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_teacherStageCourses_TermStageId",
                table: "teacherStageCourses",
                column: "TermStageId");

            migrationBuilder.CreateIndex(
                name: "IX_TermStages_ChildStageId",
                table: "TermStages",
                column: "ChildStageId");

            migrationBuilder.CreateIndex(
                name: "IX_TermStages_ParentStageId",
                table: "TermStages",
                column: "ParentStageId");
        }
