...
namespace FStudentManagement.Areas.Identity.Pages.Account
{
	public class LoginModel : PageModel
	{
		...
		public class InputModel
		{
			...
			///     directly from your code. This API may change or be removed in future releases.
			/// </summary>
			[Required(ErrorMessage = "يرجى ادخال الباسورد")]
			...
			if (ModelState.IsValid)
			{
				...
				if (result.Succeeded)
				{
					...
					if (user != null)
					{
						...
						{
							returnUrl ??= Url.Content("~/Manage/Index"); // Redirect admin to admin dashboard
						}
						else if (roles.Contains("Student"))
						{
							return RedirectToAction("std_home", "stdDashboard");
						}
						else if (roles.Contains("Teacher"))
						{
							return RedirectToAction("th_home","th_Dashboard");
